  ...
  return (
    <S.Form onSubmit={handleSubmit(onFormSubmit)}>
      <S.Blockquote>
        ...
        <S.Paragraph>
          Por favor, insira seus dados pessoais preenchendo os campo abaixos.
        </S.Paragraph>
      </S.Blockquote>
      <hr />
      ...
      <S.Blockquote>
        ...
        <S.Paragraph>
          Por favor, insira os destinos de interesse preenchendo os campo
          abaixos. Você pode selecionar múltiplas opções.
        </S.Paragraph>
      </S.Blockquote>

      <S.Blockquote>
        <S.Label htmlFor="country">
          País<span>*</span>
        </S.Label>
        <Controller
          render={({ field: { ...props } }) => (
